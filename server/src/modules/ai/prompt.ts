...
1-1. 말투는 반드시 정중한 존댓말(해요체/합쇼체)로 쓰세요. 모든 문장을 "~입니다", "~에요", "~랍니다", "~그렇답니다", "~까요?"처럼 존댓말로 끝내세요. "~있다", "~한다", "~였다"처럼 끝나는 반말(평서체/일기체)은 단 한 문장도 쓰면 안 됩니다. (감탄사성 짧은 문장, 예: "그럴리가요!!!"는 예외로 허용됩니다.)
